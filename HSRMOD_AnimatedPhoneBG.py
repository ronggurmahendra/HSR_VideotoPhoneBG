...
print('HONKAI STAR RAIL MOD SCRIPT - VIDEO TO PHONE BACK GROUND')
print('This Scripts Converts Video into pictures and config file for Phone BG mods in honkai star rail')

# modName = input('Enter Mod Name : ')
# while modName == '':
# 	modName = input('Mod name cannot be empty. \n\
# 	Enter Mod Name : ')
modName = 'HSRMOD_AnimatedPhoneBG'
...
while success and count < FRAME_COUNT:
    if frame_count % inc == 0:
        if use_resize:
        	image_resized = cv2.resize(image, (692, 1080))
        else :
            image_resized = image
